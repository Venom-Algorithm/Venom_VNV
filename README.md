...
| `px4_msgs` | [PX4](https://github.com/PX4/px4_msgs) | PX4 官方 ROS 2 消息定义，VNV 中固定到 `release/1.16` 分支，用于 PX4 飞控 DDS 接入 |
...
| 子模块 | 来源 | 说明 |
|--------|------|------|
| `rm_auto_aim` | [Venom-Algorithm](https://github.com/Venom-Algorithm/rm_auto_aim) | 目标检测、跟踪与解算能力模块 |
...
| `driver/venom_px4_bridge/` | PX4 桥接包，负责 PX4 DDS 状态打包、坐标转换、连通性探测与后续 offboard 扩展 |
